...
ax = plt.subplot()
ax.bar(range(len(protection_counts)), protection_counts.scientific_name)
...
category_counts = species.groupby(['category', 'is_protected']).scientific_name.count().reset_index().sort_values(by='category')
...
sheep_species = species[(species.sheep) & (species.category == 'Mammal')]
print sheep_species
